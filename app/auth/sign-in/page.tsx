      ...
      <div className="hidden lg:flex lg:w-[52%] relative overflow-hidden flex-col justify-between p-12"
        ...
        {FOOD_EMOJIS.map((e, i) => (
          <span key={i} className={e.anim}
            style={{ position: "absolute", top: e.top, left: e.left, fontSize: e.size, opacity: e.opacity,
        ...
        {/* Footer */}
        <p className="relative z-10 text-white/25 text-xs">© 2026 FoodHub. All rights reserved.</p>
      </div>
        ...
        <div className="w-full flex flex-col items-center gap-5">
          ...
          {role === "merchant" && (
            <p className="text-sm text-stone-400 text-center">
              New restaurant?{" "}
              <Link href="/sign-up" className="font-semibold text-orange-500 hover:text-orange-600 transition-colors">
