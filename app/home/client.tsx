...
import { useGetTrendingProducts, useListCategories, useGetTrendingMerchants } from "@/utils/api";
      ...
      <section className="py-16 px-4 bg-muted/40">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold">How HungerHub works</h2>
