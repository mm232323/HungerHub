      ...
      <DialogContent className="sm:max-w-2xl p-0 overflow-hidden">
        ...
        <ScrollArea className="max-h-[75vh]">
          <div className="p-6 space-y-8">
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-semibold text-stone-500 uppercase tracking-wider">Availability</h3>
              <div className="flex items-center gap-3 bg-stone-50/50 p-4 rounded-xl border border-stone-100">
                  ...
                  <div className="flex flex-col">
                      <span className="font-semibold text-sm">Product Status</span>
                      <span className="text-xs text-stone-500">Enable this to make the product visible to customers.</span>
                  </div>
              </div>
            </div>
        ...
        <div className="p-4 border-t bg-stone-50 flex justify-end gap-3 rounded-b-lg">
          ...
          <Button onClick={handleSave} disabled={updateProduct.isPending}>
            {updateProduct.isPending ? t("saving") : "Save Changes"}
          </Button>
        </div>
      </DialogContent>
    </Dialog>
        ...
        filteredProducts.map((product) => (
          <Card key={product.id} className="overflow-hidden border border-stone-200 shadow-sm hover:shadow-md transition-shadow rounded-[24px] bg-white flex flex-col group">
            ...
            <CardContent className="p-5 flex flex-col flex-1 gap-4">
              ...
              {/* Price */}
              <div>
                <p className="text-sm text-stone-500 font-medium mb-0.5">Price</p>
