    ...
    <div className="relative z-10 w-full max-w-2xl auth-slide-up">
      ...
      <div className="flex justify-center mb-10">
        <Link href="/" className="inline-flex items-center gap-3 group">
          ...
          <span className="text-3xl font-black text-white tracking-tight">HungerHub</span>
        </Link>
      </div>

      {/* Headline */}
      <div className="text-center mb-10 space-y-2">
        <h1 className="text-4xl font-black text-white">Join HungerHub</h1>
      ...
      <p className="text-center text-sm text-white/35 mt-8">
        ...
        <Link href="/auth/sign-in" className="font-semibold text-orange-400 hover:text-orange-300 transition-colors">
          Sign in
        </Link>
      </p>
    </div>
        ...
        <>
          ...
          {BG_EMOJIS.map((e, i) => (
            <span key={i} className={e.anim}
              style={{
                position: "fixed", top: e.top, left: e.left, fontSize: e.size, opacity: e.opacity,
        ...
        <>
          ...
          <div className="hidden lg:flex lg:w-[52%] relative overflow-hidden flex-col justify-between p-12"
            ...
            {BG_EMOJIS.slice(0, 5).map((e, i) => (
              <span key={i} className={e.anim}
                style={{
                  position: "absolute", top: e.top, left: e.left, fontSize: e.size, opacity: (e.opacity + 0.4), animationDelay: e.delay,
            ...
            <div className="relative z-10">
              <Link href="/" className="inline-flex items-center gap-3 group">
                ...
                <span className="text-2xl font-bold text-white">HungerHub</span>
              </Link>
            </div>
            ...
            <div className="relative z-10 space-y-5">
              ...
              {/* Role badge */}
              <div className={`inline-flex items-center gap-2 rounded-full px-4 py-2 border ${role === "merchant"
            ...
            <p className="relative z-10 text-white/20 text-xs">© 2026 HungerHub. All rights reserved.</p>
          </div>
            ...
            <div className="w-full flex flex-col items-center gap-4 auth-slide-up">
              ...
              <div className="w-[440px] max-w-full flex items-center justify-between">
                <button
                  ...
                  className="flex items-center gap-1 text-stone-400 hover:text-stone-600 text-sm transition-colors cursor-pointer"
                >
                  <ChevronLeft className="h-4 w-4" />
                  Change role
                </button>
                <span className="inline-flex items-center gap-1.5 text-xs font-bold px-3 py-1.5 rounded-full bg-orange-50 text-orange-600 border border-orange-100">
