    ...
    <>
      <div>
        ...
        <Input
          ...
          placeholder="e.g. The Smoky Spoon"
      ...
      <div>
        ...
        <Textarea
          ...
          placeholder="Tell customers what makes your food special. What's your story?"
          rows={4}
      ...
      <div className="flex items-center gap-3 p-4 bg-orange-50 rounded-xl border border-orange-100">
        ...
        <p className="text-sm text-orange-700">
          <strong>Tip:</strong> Restaurants with a great story get
          3× more followers on FoodHub.
        </p>
      </div>
    </>
  );
